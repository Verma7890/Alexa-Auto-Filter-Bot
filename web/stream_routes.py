...
<head>
    <meta charset="UTF-8">
    <link rel="shortcut icon" href="https://telegra.ph/file/8ff6bafd11dca573bb953.jpg" type="image/x-icon">
    <meta property="og:image" content="https://telegra.ph/file/8ff6bafd11dca573bb953.jpg" itemprop="thumbnailUrl">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>{{file_name}} | Teamrioupdates</title>
            ...
            <nav class="navbar bg-dark p-lg-4 p-2">
               <div class="d-flex ">
                ...
                <div class="offcanvas-header d-block">
                    ...
                    <div class="d-flex ">
                        <!-- logo -->
                        <img src="https://telegra.ph/file/8ff6bafd11dca573bb953.jpg" width="80" height="80" class="rounded" style="box-shadow: 3px 5px 11px black;" alt="">
                        <div class="p-3">
                            <h4 class="offcanvas-title font-semibold wow animate__animated animate__fadeInLeft " id="offcanvasWithBothOptionsLabel" style="text-shadow: 3px 5px 11px black;" >TEAM-RIO-NETWORKS</h4>
                    ...
                    <div class="d-flex gap-1 px-1 mt-1 wow animate__animated animate__fadeInLeft animate__delay-1s ">
                        ...
                        <a href="https://telegram.me/Teamrioupdates" target="_blank" class="btn btn-primary w-50 text-light  fw-semibold flex justify-center items-center gap-2 text-xs">
                ...
                <div class="offcanvas-body">
                    ...
                    <div class=" d-block px-5 wow animate__animated animate__fadeInRight ">
                        ...
                        <a href="https://t.me/tamilmovies4Krio" type="button" class="btn btn-outline-secondary w-100 mt-1">Popular on MoviesAdda</a>
                ...
                <div class="m-2 mt-4">
                    ...
                    <div class="text-center w-100">
                        ...
                        <div class="text-center w-100 px-2 flex justify-center items-center gap-2">
                            ...
                            <span class="font-bold bg-clip-text text-[18px] text-transparent bg-gradient-to-r from-yellow-400  via-orange-700 to-red-700" style="text-shadow: 3px 5px 11px black;">LazyDeveloperr</span>
                        </div>
                    </div>
            ...
            <div class="justify-content-center align-items-center w-100 d-flex">
                    <div class="row d-flex w-100 justify-content-center align-items-center">
                        ...
                        <div class="col-lg-6 col-10 d-flex justify-center items-center flex-wrap pb-3 gap-2 wow animate__animated animate__fadeIn">
                            ...
                            <div onclick="lazyDownload()" class="col-lg-4 p-2 col-12 rounded-3xl bg-dark text-white text-center align-items-center hover:bg-gradient-to-r from-pink-500 to-violet-500 hover:shadow-md hover:shadow-gray-100 hover:translate-y-[-5px] transition transition-all duration-300 wow animate__animated animate__rubberBand">
                                Download Now
                            </div>
                        </div>
                </div>
            ...
            <div class="justify-content-center align-items-center w-100 d-flex mb-3">
                <div class="row d-flex w-100 justify-content-center align-items-center">
                    <div class="col-lg-5 col-10  py-2 text-center bg-success rounded-4 text-sm wow animate__animated animate__FadeIn">
                        If you find any broken links then please contact <a href="https://telegram.me/creatorrio" class="text-[16px] font-bold underline active:text-blue-600">Teamrioupdates</a>
                    </div>
                </div>
            </div>
        ...
        <footer class="bg-dark justify-content-around align-items-center">
            <div class="container-fluid  justify-content-center align-itemsd x. -center">
                ...
                <section class="lg:p-4 p-2 justify-content-center align-items-center text-center ">  
                    <!-- YouTube -->
                    <a class="btn btn-outline-light btn-floating m-1 rounded-circle p-2 border-secondary wow animate__animated animate__fadeInLeft hover:shadow-md hover:shadow-gray-400 hover:translate-y-[-5px] transition transition-all duration-200" href="https://youtube.com/" target="_blank" role="button">
                  ...
                  <div class="row flex-row-reverse text-secondary justify-content-center align-items-center">
                      <div class="col-lg-6 col-12 justify-content-center align-items-center text-center p-1 wow animate__animated animate__fadeInRight">
                        <ul class="navbar-nav">
                            <li class="navbar-item bg-gradient-to-r from-pink-500 rounded-xl p-2"> <h5 class="text-gray-100 font-semibold text-sm"> Think & just code it... </h5><sup class="badge badge-error text-xs text-gray-300 font-monospace">-Teamrioupdates</sup> </li>
                        </ul>
                    </div>
                    <div class="col-lg-6 col-12 justify-content-center align-items-center text-center p-1 wow animate__animated animate__fadeInLeft">
                        <ul class="navbar-nav">
                            <li class="navbar-item bg-gradient-to-l from-pink-500 rounded-xl p-2 "> <h5 class="text-gray-100 font-semibold text-sm" > Success is the journey of millions of failure and lots of hard work </h5> <sup class="badge  text-xs text-gray-300 font-monospace">-Teamrioupdates</sup> </li>
                        </ul>
                    </div>
                    <div class="col-lg-2 col-4 justify-content-center align-items-center text-center mt-lg-0 mt-5  pt-lg-0 pt-4 wow animate__animated animate__fadeInUp">
                        <ul class="navbar-nav ">
                            <li class="nav-item justify-center items-center flex"  style="margin-top: -40px;">
                                <img src="https://telegra.ph/file/8ff6bafd11dca573bb953.jpg" height="140px" class="rounded-3 " alt="logo">
                            </li>
                            <!-- <li class="nav-item justify-center items-center text-center">
                                <a  class="nav-link h1 text-center sm:-m-1 -ms-4"><h5><a class="font-bold" href="https://t.me/tamilmovies4Krio" target="_blank">For Movies : </a>Special Thanks to Helping This Journey 🥰 <a href="https://telegram.me/Lazydeveloperr" target="_blank" class="bg-clip-text text-[16px] text-transparent bg-gradient-to-r from-orange-500 to-pink-500">Lazydeveloperr</a> & <a href="https://telegram.me/creatorrio" target="_blank">For any Errors Contact(<a href="https://telegram.me/Teamrioupdates" target="_blank" class="bg-clip-text text-[16px] text-transparent bg-gradient-to-r from-orange-500 to-pink-500">LazyDeveloper</a>)</a> </h5></a>
                            </li> -->
                        </ul>
                    </div>
                ...
                <div class=" justify-center items-center text-center w-full text-center flex ">
                    <div  class="text-gray-400 text-center sm:-m-1 -ms-4 m-2 p-2">
                        <h5>
                            <a class="font-bold" href="https://t.me/tamilmovies4Krio" target="_blank">Movies : </a>Special Thanks to Helping This journey 🥰 <a href="https://telegram.me/Lazydeveloperr" target="_blank" class="bg-clip-text text-[16px] text-transparent bg-gradient-to-r from-orange-500 to-pink-500">Lazydeveloperr</a> & <a href="https://telegram.me/creatorrio" target="_blank">For Any Error Contact(<a href="https://telegram.me/Teamrioupdates" target="_blank" class="bg-clip-text text-[16px] text-transparent bg-gradient-to-r from-orange-500 to-pink-500">UPDATES</a>)
                            </a> 
                        </h5>
                    </div>
                </div>
            ...
            ©  <script type="text/JavaScript">
                ...
                <a class="bg-clip-text text-[16px] text-transparent bg-gradient-to-r from-pink-500 to-violet-500 font-bold tracking-wide px-1" href="https://telegram.me/creatorrio">Teamrioupdates</a>
                <!--🥰  Thank you for giving me credit @LazyDeveloperr & @creatorrio  🥰 -->
                All right reserved
            </div>   
        </footer>

<!-- if you are for this source code then please thanks to me @LazyDeveloperr && Dont remove the cr -->
    ...
    <!--🥰 Thanks you for giving me credit @LazyDeveloper & @creatorrio  🥰 -->
</body>
</html>
